...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        // We catch errors specific to signup here so we only show success if it actually worked
        try {
            ...
            <div className={styles.card}>
                ...
                {verificationSent ? (
                    <div className={styles.verificationState}>
                        ...
                        <p className={styles.verifySubtext}>Please click the link in the email to activate your account before logging in.</p>
